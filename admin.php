...
<form class="textos" action="admin.php?var=<?php echo $x?>" method="POST">
  <div class="form-row">
...
?>
  ...
  ?>
  <a href="admin.php?var=0" class="btn btn-outline <?= $estilopendente ?>" id="btnpendente">Pendentes</a>
  <a href="admin.php?var=1" class="btn btn-outline <?= $estiloverificado ?>" id="btnverificado">Verificados</a>
  <button class="btn btn-cad" data-toggle="modal" data-target="#alterarcoordenador" style="position: relative; float: right;">Coordenadores</button>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <h5 class="modal-title" id="titulomodal">Escolha: 
          <button type="button" class="btn btn-outline active" id="abrirmodalprojeto" name="abrirmodalprojeto">Projeto</button>
          <button type="button" class="btn btn-outline" id="abrirmodalprof" name="abrirmodalprof">Professor</button>
          <button type="button" class="btn btn-outline" id="abrirmodalcurso" name="abrirmodalcurso">Curso</button>
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar" id="apagar">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div id="modalprof" style="display: none;">
      <form>
      ...
      <div class="form-group">
        ...
        <select id="idCurso" class="form-control" name="idCurso">
      ...
      <div class="pretty p-svg p-curve ml-3 mb-4">
        <input type="checkbox" name="coordenador" id="coordenador">
...
<div id="modalcurso" style="display: none;">
  <form>
    <div class="modal-body">
        ...
        <input type="text" class="form-control" id="nomecurso" name="nomecurso" placeholder="Nome do curso" maxlength="50" required>
      </div>
    </div>
      <div class="modal-footer">
        <button type="reset" class="btn btn-outline" data-dismiss="modal" id="btnsair">Cancelar</button>
        <button type="button" class="btn btn-outline-primary" id="btncadcurso">Cadastrar</button>
  </div>
      </form>
</div>
...
<div class="modal fade" id="alterarcoordenador" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="titulomodal">Alterar coordenador
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar" id="apagar">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <select id="cursoprof" class="form-control" name="cursoprof" style="width: 150%;">
        <?php
        $sqlcurso = "SELECT * FROM curso";        
        $pdocurso = $con->prepare($sqlcurso);
        $pdocurso->execute();
      ...
      <select id="professores" class="form-control" name="professores" style="width: 150%;">
      </select>
    </div>
    </div>

      <div class="modal-footer">
        <button type="button" id="btnatualizarcoordenador" class="btn etec">Atualizar</button>
      </div>
</form>
<label id="sucessocoor" style="display: none;">
          Coordenador do curso atualizado!
        </label>
</div>
      </div>
</div>
